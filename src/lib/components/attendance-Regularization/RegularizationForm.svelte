  ...
  <form on:submit|preventDefault={handleSubmit} class="p-6 space-y-6">
    ...
    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
      <div class="grid grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-gray-500" for="date"
            >Date</label
          >
        ...
        <div>
          <label
            ...
            for="shift-code">Shift Code</label
          >
          <div class="mt-1 text-sm font-semibold text-gray-800">
      ...
      <div class="mt-4">
        <label
          class="block text-sm font-medium text-gray-500"
          for="shift-timing">Shift Timing</label
        >
        <div
          class="mt-1 flex items-center space-x-2 text-sm font-semibold text-gray-800"
        >
    ...
    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
      <label
        class="block text-sm font-medium text-gray-500"
        for="approver-details">Approver Details</label
      >
