<script lang="ts">
  ...
  function validateBasicInfoField(field: string, value: string) {
    switch (field) {
      case "firstName":
        basicInfoErrors.firstName = value.trim()
          ? ""
  ...
  function validateBasicInfoForm() {
    Object.keys(basicInfo).forEach((key) =>
      validateBasicInfoField(key, basicInfo[key])
    );
    basicInfoFormValid = Object.values(basicInfoErrors).every(
      (err) => err === ""
    );
  }
  ...
  function validateBankForm() {
    Object.keys(bankFormData).forEach((key) =>
      validateBankField(key, bankFormData[key])
    );
    ...
    <div class="bg-white shadow-lg rounded-xl p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-8">
        ...
        <div class="info-item">
          ...
          <p class="mt-1 text-base text-gray-900">
            {formatDate(basicInfo.joiningDate)}
          </p>
        </div>
  ...
  {#if activeTab === "Bank Information"}
    <div class="bg-white shadow-lg rounded-xl p-6">
      ...
      {#each bankDetails as detail (detail.accountNumber)}
        {#if detail.isActive}
          <div
            class="bank-card-compact bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 mb-4"
          >
            <div class="p-4">
      ...
      {#if bankDetails.length === 0}
        <button
          ...
          on:click={() => (showBankForm = !showBankForm)}
        >
      ...
      {#if showBankForm}
        <form
          on:submit|preventDefault={handleBankSubmit}
          class="space-y-6 mt-4 p-4 bg-base-200 rounded-lg shadow-lg"
        >
          <div class="form-control">
            ...
            <input
              ...
              type="text"
              class="input input-bordered {bankErrors.accountHolderName
                ? 'input-error'
                : ''}"
            ...
            {#if bankErrors.accountHolderName}
              <span class="text-error text-sm"
                >{bankErrors.accountHolderName}</span
              >
            {/if}
          </div>
          <div class="form-control">
            ...
            <input
              id="accountNumber"
              type="text"
              class="input input-bordered {bankErrors.accountNumber
                ? 'input-error'
                : ''}"
          ...
          <div class="form-control">
            ...
            <select
              id="bankName"
              class="select select-bordered {bankErrors.bankName
                ? 'input-error'
                : ''}"
          ...
          <div class="form-control">
            ...
            <input
              id="ifscCode"
              type="text"
              class="input input-bordered {bankErrors.ifscCode
                ? 'input-error'
                : ''}"
  ...
  {#if activeTab === "Document Details"}
    <div class="bg-white shadow-lg rounded-xl p-6">
      ...
      {#if !showDocumentForm && employee.governmentIds && Object.keys(employee.governmentIds).length > 0}
        ...
        <button
          class="btn btn-primary mt-4"
          on:click={() => (showDocumentForm = true)}
        >
          Edit
        </button>
        ...
        <form on:submit|preventDefault={handleDocumentSubmit} class="space-y-6">
          <div class="form-control">
            ...
            <input
              id="panNumber"
              type="text"
              class="input input-bordered {documentErrors.panNumber
                ? 'input-error'
                : ''}"
          ...
          <div class="form-control">
            ...
            <input
              id="aadhaarNumber"
              type="text"
              class="input input-bordered {documentErrors.aadhaarNumber
                ? 'input-error'
                : ''}"
              bind:value={governmentIds.aadhaarNumber}
              on:input={(e) =>
                handleDocumentInput("aadhaarNumber", e.target.value)}
            />
            {#if documentErrors.aadhaarNumber}
              <span class="text-error text-sm"
                >{documentErrors.aadhaarNumber}</span
              >
            {/if}
          </div>
          <div class="form-control">
            ...
            <input
              id="passportNumber"
              type="text"
              class="input input-bordered {documentErrors.passportNumber
                ? 'input-error'
                : ''}"
              bind:value={governmentIds.passportNumber}
              on:input={(e) =>
                handleDocumentInput("passportNumber", e.target.value)}
            />
            {#if documentErrors.passportNumber}
              <span class="text-error text-sm"
                >{documentErrors.passportNumber}</span
              >
            {/if}
          </div>
          <div class="form-control">
            ...
            <input
              id="voterId"
              type="text"
              class="input input-bordered {documentErrors.voterId
                ? 'input-error'
                : ''}"
          ...
          <div class="form-control">
            ...
            <input
              id="drivingLicense"
              type="text"
              class="input input-bordered {documentErrors.drivingLicense
                ? 'input-error'
                : ''}"
              bind:value={governmentIds.drivingLicense}
              on:input={(e) =>
                handleDocumentInput("drivingLicense", e.target.value)}
            />
            {#if documentErrors.drivingLicense}
              <span class="text-error text-sm"
                >{documentErrors.drivingLicense}</span
              >
            {/if}
          </div>
