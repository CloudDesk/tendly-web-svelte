  ...
  <div class="card-body space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="text-sm text-neutral-500" for="description"
            >Description</label
          >
        ...
        <div>
          <label class="text-sm text-neutral-500" for="status">Status</label>
          <div class="mt-1">
        ...
        <div>
          <label class="text-sm text-neutral-500" for="type">Type</label>
          <div class="mt-1 font-medium">{training.type}</div>
        </div>

        <div>
          <label class="text-sm text-neutral-500" for="mode">Mode</label>
      ...
      <div class="space-y-4">
        <div>
          <label class="text-sm text-neutral-500" for="starttime"
        ...
        <div>
          <label class="text-sm text-neutral-500" for="endtime"
            >End Date & Time</label
          >
        ...
        {#if training.maxParticipants}
          <div>
            <label class="text-sm text-neutral-500" for="participants"
              >Participants</label
            >
        ...
        {#if training.mode !== "online" && training.venue}
          <div>
            <label class="text-sm text-neutral-500" for="venue">Venue</label>
        ...
        {#if training.mode !== "offline" && training.meetingLink}
          <div>
            <label class="text-sm text-neutral-500" for="meetinglink"
              >Meeting Link</label
            >
            <div class="mt-1">
              <a
    ...
    <div class="border-t pt-6">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="text-sm text-neutral-500" for="trainer-name">Name</label
          >
          <div class="mt-1 font-medium">{training.trainer.name}</div>
        </div>

        <div>
          <label class="text-sm text-neutral-500" for="trainer-email"
            >Email</label
          >
          <div class="mt-1">
        ...
        {#if training.trainer.phone}
          <div>
            <label class="text-sm text-neutral-500" for="trainer-phone"
              >Phone</label
            >
            <div class="mt-1">
        ...
        {#if training.trainer.organization}
          <div>
            <label class="text-sm text-neutral-500" for="organization"
              >Organization</label
            >
