  ...
  {#if selectedShift}
    <div class="space-y-4">
      ...
      <div>
        ...
        <p>
          {selectedShift.validFrom} - {selectedShift.validTill || "No end date"}
        </p>
      </div>
...
>
  ...
  {:else}
    <div class="space-y-4">
      <div class="bg-base-200 rounded-lg p-4">
        ...
        <div class="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
          ...
          <div>
            ...
            <span class="ml-1"
              >{selectedShift?.shiftWindowStart} - {selectedShift?.shiftWindowEnd}</span
            >
          </div>
          <div>
            <span class="text-base-content/70">Validity:</span>
            <span class="ml-1"
              >{selectedShift?.validFrom} - {selectedShift?.validTill ||
                "No end date"}</span
            >
          </div>
          <div>
            ...
            <span class="ml-1"
              >{selectedShift?.graceTimeInMinutes || 0} minutes</span
            >
          </div>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="form-control">
          <label class="label" for="validfrom">Assignment Valid From</label>
          <input
            type="date"
            class="input input-bordered"
        ...
        <div class="form-control">
          <label class="label" for="validtill">Assignment Valid Till</label>
          <input
            type="date"
            class="input input-bordered"
            ...
            <div class="p-3">
              ...
              <p class="text-sm text-base-content/70">
                ...
                {employee.upcomingShiftAssignmentData
                  ? `Current: ${employee.upcomingShiftAssignmentData.shiftCode} Shift`
                  : "No current shift"}
              </p>
            </div>
          {/each}
