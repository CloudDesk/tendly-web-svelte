<script lang="ts">
  ...
  export let filters: filterSchema[] = [];
  export let values: Record<string, any> = {};
  export let isOpen = false;

  console.log(values,"filters schma")
...
>
  ...
  class="w-full rounded-lg border border-gray-300 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-100 
         py-2.5 pl-3 pr-10 text-sm text-gray-700 transition-all duration-200 disabled:bg-gray-100 disabled:cursor-not-allowed"
