<script lang="ts">
  ...
  const columns = [
    ...
    },
    {
      ...
      label: "Validity",
      render: (row: Training) =>
        `${row.validFrom} - ${row.validTill || "No end date"}`,
    },
    {
      key: "graceTime",
      label: "Grace Time",
  ...
  async function loadTrainings() {
    try {
      loading = true;
      const response: any = await trainingsApi.list({
...
>
  <form on:submit|preventDefault={handleSubmit} class="space-y-4">
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="form-control">
        <label class="label" for="windowstart">Training Window Start</label>
        <input
          type="time"
          class="input input-bordered"
      ...
      <div class="form-control">
        <label class="label" for="windowend">Training Window End</label>
        <input
          type="time"
          class="input input-bordered"
    ...
    <div class="form-control">
      <label class="label" for="gracetime">Grace Time (minutes)</label>
      <input
        type="number"
        class="input input-bordered"
    ...
    <div class="grid grid-cols-2 gap-4">
      <div class="form-control">
        <label class="label" for="participants">Max Participants</label>
        <input
          type="number"
          class="input input-bordered"
  ...
  {#if selectedTraining}
    <div class="space-y-4">
      ...
      <div>
        ...
        <p>
          {selectedTraining.validFrom} - {selectedTraining.validTill ||
            "No end date"}
        </p>
      </div>

      <div>
        <label class="font-semibold" for="gracetime">Grace Time:</label>
        <p>{selectedTraining.graceTimeInMinutes || 0} minutes</p>
      </div>

      <div>
        <label class="font-semibold" for="maxparticipants"
...
>
  ...
  {:else}
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-2 gap-4">
        <div class="form-control">
          <label class="label" for="assignvalidfrom"
        ...
        <div class="form-control">
          <label class="label" for="assignvalidtill"
